...
public class task3 {
    public static void main(String[] args){
        ...
        System.out.println("Задание 6 = " + inat("oooo"));
    ...
    public static int warOfNumber(int[] mass){
        ...
        if (chetSum>nSum){return chetSum-nSum;} else{
            return nSum-chetSum;
        }
    }
...
возвращает true, если этот кирпич может поместиться в отверстие с шириной(w) и высотой(h).
     */
    public static boolean doesBrickFit(int a, int b, int c, int w, int h){return (((w>=a||w>=b)&&h>=c)||((w>=a||w>=c)&&h>=b)||((w>=b||w>=c)&&h>=a));}
